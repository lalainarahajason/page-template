...
class DPT {
	...
	*/
	...
	public function __construct() {
		...
		// Add scripts to specific template
		add_action('wp', array($this, 'new_template_scripts') );
	...
	public function view_project_template( $template ) {
		...
		$file = DPT_PLUGIN_DIR . '/' . get_post_meta( 
			$post->ID, '_wp_page_template', true
		);
	...
	/**
	 * Checks if the specifi template
	 */
